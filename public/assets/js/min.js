...
$(document).ready(function () {
  ...
  $(window).scroll(function () {
    ...
    if (wScroll > $("#portofolioSection").offset().top - 150) {
...
$(function ($) {
  var followScroll = $(".followScroll"),
    ...
    topMargin = 20,
    scrollStop = $(".scrollStop").offset().top - 350;
...
/******/ 	__webpack_require__.O(undefined, ["assets/css/min"], () => (__webpack_require__("./src/js/min.js")))
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["assets/css/min"], () => (__webpack_require__("./src/sass/min.scss")))
